...
<div class="header w1210 bc mt15">
    ...
    <div class="logo w1210">
        ...
        <div class="search fl">
            <div class="search_form">
                ...
                <?php
                echo \yii\helpers\Html::beginForm(\yii\helpers\Url::to(['goods/test']),'get',['name'=>'serarch','class'=>'fl']);
                echo \yii\helpers\Html::textInput('keyword','请输入商品关键字',['class'=>'txt']);
                echo \yii\helpers\Html::submitInput('搜索',['class'=>'btn']);
                echo \yii\helpers\Html::endForm();
                ?>
                <!--<form action="goods/index.html" name="serarch" method="get" class="fl">
    ...
    <div class="nav w1210 bc mt10">
        ...
        <div class="category fl"> <!-- 非首页，需要添加cat1类 -->
            ...
            <div class="cat_bd">
                <?php $cates=\backend\models\GoodsCategory::findAll(['parent_id'=>0]);?>
                <?php foreach ($cates as $k=>$cate):?>
                    <div class="cat <?=$k==0?'item1':'';?>">
                        <h3><a href="http://www.yii2log.com/goods/list.html?id=<?=$cate->id?>"><?=$cate->name?></a> <b></b></h3>
                        <div class="cat_detail">
                            <?php foreach ($cate->child as $k2=>$child):?>
                                <dl <?=$k2==0?'class="dl_1st"':'';?>>
                                    <dt><a href="http://www.yii2log.com/goods/list.html?id=<?=$child->id?>"><?=$child->name?></a></dt>
                                    <dd>
                                        <?php foreach ($child->child as $row):?>
                                            <a href="http://www.yii2log.com/goods/list.html?id=<?=$row->id?>"><?=$row->name?></a>
                                        <?php endforeach;?>
                                    </dd>
                                </dl>
                            <?php endforeach;?>
...
<div class="guide w1210 bc mt15">
        ...
        <div class="guide_wrap">
            ...
            <div class="hot none">
                <ul>
                    ...
                    <li>
                        <dl>
                            <dt><a href=""><?=\yii\helpers\Html::img('@web/images/hot3.jpg')?></a></dt>
            ...
            <div class="recommend none">
                <ul>
                    ...
                    <li>
                        <dl>
                            <dt><a href=""><?=\yii\helpers\Html::img('@web/images/recommend2.jpg')?></a></dt>
                    ...
                    <li>
                        <dl>
                            <dt><a href=""><?=\yii\helpers\Html::img('@web/images/recommend3.jpg')?></a></dt>
    ...
    <div class="sidebar fl ml10">
        ...
        <div class="sidebar_wrap">
            <dl class="first">
                <dt class="fl"><a href=""><?=\yii\helpers\Html::img('@web/images/viewsonic.jpg')?></a></dt>
            ...
            <dl>
                <dt class="fr"><a href=""><?=\yii\helpers\Html::img('@web/images/samsung.jpg')?></a></dt>
...
<div class="floor1 floor w1210 bc mt10">
    ...
    <div class="floor_left fl">
        ...
        <div class="cate fl">
            ...
            <div class="cate_wrap">
                ...
                <p><a href=""><?=\yii\helpers\Html::img('@web/images/notebook.jpg')?></a></p>
            </div>
            ...
            <div class="goodslist_wrap">
                <div>
                    <ul>
                        ...
                        <li>
                            <dl>
                                <dt><a href=""><?=\yii\helpers\Html::img('@web/images/thinkpad e420.jpg')?></a></dt>
                        ...
                        <li>
                            <dl>
                                <dt><a href=""><?=\yii\helpers\Html::img('@web/images/acer4739.jpg')?></a></dt>
                        ...
                        <li>
                            <dl>
                                <dt><a href=""><?=\yii\helpers\Html::img('@web/images/samsung6800.jpg')?></a></dt>
                        ...
                        <li>
                            <dl>
                                <dt><a href=""><?=\yii\helpers\Html::img('@web/images/lh531.jpg')?></a></dt>
                        ...
                        <li>
                            <dl>
                                <dt><a href=""><?=\yii\helpers\Html::img('@web/images/qinghuax2.jpg')?></a></dt>
    ...
    <div class="sidebar fl ml10">
        ...
        <div class="brand">
            ...
            <div class="sidebar_wrap">
                <ul>
                    <li><a href=""><?=\yii\helpers\Html::img('@web/images/dell.gif')?></a></li>
                    <li><a href=""><?=\yii\helpers\Html::img('@web/images/acer.gif')?></a></li>
                    <li><a href=""><?=\yii\helpers\Html::img('@web/images/fujitsu.jpg')?></a></li>
                    <li><a href=""><?=\yii\helpers\Html::img('@web/images/hp.jpg')?></a></li>
                    <li><a href=""><?=\yii\helpers\Html::img('@web/images/lenove.jpg')?></a></li>
                    <li><a href=""><?=\yii\helpers\Html::img('@web/images/samsung.gif')?></a></li>
                    <li><a href=""><?=\yii\helpers\Html::img('@web/images/dlink.gif')?></a></li>
                    <li><a href=""><?=\yii\helpers\Html::img('@web/images/seagate.jpg')?></a></li>
                    <li><a href=""><?=\yii\helpers\Html::img('@web/images/intel.jpg')?></a></li>
                </ul>
            </div>
        </div>
        <!-- 品牌旗舰店 end -->
        ...
        <!-- 广告 start -->
        <div class="ads mt10">
            <a href=""><?=\yii\helpers\Html::img('@web/images/canon.jpg')?></a>
        </div>
        <!-- 广告 end -->
    </div>
    <!-- 右侧 end -->
