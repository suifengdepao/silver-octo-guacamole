...
<div class="list w1210 bc mt10">
    ...
    <div class="list_left fl mt10">
        ...
        <div class="newgoods leftbar mt10">
            ...
            <div class="leftbar_wrap">
                <ul>
                    <li>
                        <dl>
                            <dt><a href=""><?=\yii\helpers\Html::img('@web/images/list_hot1.jpg')?></a></dt>
                    ...
                    <li>
                        <dl>
                            <dt><a href=""><a href=""><?=\yii\helpers\Html::img('@web/images/list_hot2.jpg')?></a></dt>
                    ...
                    <li class="last">
                        <dl>
                            <dt><a href=""><a href=""><?=\yii\helpers\Html::img('@web/images/list_hot3.jpg')?></a></dt>
        ...
        <div class="viewd leftbar mt10">
            ...
            <div class="leftbar_wrap">
                <dl>
                    <dt><a href=""><a href=""><?=\yii\helpers\Html::img('@web/images/hpG4.jpg')?></a></dt>
                    <dd><a href="">惠普G4-1332TX 14英寸笔记...</a></dd>
                </dl>

                <dl class="last">
                    <dt><a href=""><a href=""><?=\yii\helpers\Html::img('@web/images/crazy4.jpg')?></a></dt>
        ...
        <div class="list_top">
            ...
            <div class="hotsale fl">
                ...
                <ul>
                    ...
                    <li>
                        <dl>
                            <dt><a href=""><a href=""><?=\yii\helpers\Html::img('@web/images/acer4739.jpg')?></a></dt>
            ...
            <div class="filter_wrap">
                <dl>
                    ...
                    <?php foreach ($brands as $brand):?>
                        <dd><?=\yii\helpers\Html::a($brand->name,'')?></dd>
                    <?php endforeach;?>
        ...
        <div class="goodslist mt10">
            <ul>
                <?php foreach ($goods as $good):?>
                    <li>
                        <dl>
                            <dt><?=\yii\helpers\Html::a(\yii\helpers\Html::img($good->logo))?></dt>
                            <dt><?=\yii\helpers\Html::a($good->name,['intro','id'=>$good->id])?></dt>
                            <dt><strong><?=$good->shop_price?></strong></dt>
                        </dl>
                    </li>
                <?php endforeach;?>
            </ul>
