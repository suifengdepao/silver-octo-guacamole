    ...
    <div class="goods_content fl mt10 ml10">
        ...
        <div class="summary">
            ...
            <div class="preview fl">
                <div class="midpic">
                    <?/*=\yii\helpers\Html::a(\yii\helpers\Html::img('@web/images/preview_m1.jpg'),'images/preview_l1.jpg')*/?>
                    <a href="images/preview_l1.jpg" class="jqzoom" rel="gal1">   <!-- 第一幅图片的大图 class 和 rel属性不能更改 -->
                        <?=\yii\helpers\Html::img('@web/images/preview_m1.jpg'/*$good->logo*/)?>              <!-- 第一幅图片的中图 -->
                    </a>
                </div>
                ...
                <div class="smallpic">
                    ...
                    <div class="smallpic_wrap">
                        <ul>
                            <li class="cur">
                                <a class="zoomThumbActive" href="javascript:void(0);" rel="{gallery: 'gal1', smallimage: 'images/preview_m1.jpg',largeimage: 'images/preview_l1.jpg'}"><?=\yii\helpers\Html::img('@web/images/preview_s1.jpg')?></a>
                            </li>
                            <li>
                                <a href="javascript:void(0);" rel="{gallery: 'gal1', smallimage: 'images/preview_m2.jpg',largeimage: 'images/preview_l2.jpg'}"><?=\yii\helpers\Html::img('@web/images/preview_s2.jpg')?></a>
                            </li>
                            <li>
            ...
            <div class="goodsinfo fl ml10">
                ...
                <form action="<?=\yii\helpers\Url::to(['goods/add-flow'])?>" method="post" class="choose">
                    <ul>
